...
return [
  ...
  's3.1' => '<p>Portugal</p>',
  's3.2' => '<p>Outside Portugal</p>',
  's4' => '<p>Do you have a disability or experience any limitations preventing you from reaching a polling station?</p>',
  's4.1' => '<p>Yes</p>',
  's4.2' => '<p>No</p>',
  's5' => '<p><em>For Portuguese and other EU citizens:</em></p>
<p><strong>Where do I vote?</strong> You can find out your polling station:</p>
<ul>
...
<p><strong>For voters with mobility issues or physical disabilities:</strong></p>
<ul>
<li>Voters affected by serious illnesses or physical disabilities can vote with the help of another voter they choose, ensuring the secrecy and accuracy of their vote.</li>
<li>If a voter with a disability can\'t physically access the polling station (e.g., in a wheelchair or on a stretcher), they must be allowed to vote alone in a designated spot within the polling station\'s view.</li>
</ul>
<p><strong>For visually impaired and partially sighted voters:</strong></p>
<ul>
<li>Visually impaired and partially sighted voters in Portugal\'s European elections can vote independently with the support of a braille matrix and an explanatory sheet with enlarged letters provided by the polling station.</li>
</ul>',
  's6' => '<p><em>For Portuguese and other EU citizens:</em></p>
<p><strong>Where do I vote?</strong> You can find out your polling station:</p>
<ul>
<li>by consulting the public notices on the distribution of polling stations</li>
<li>at your local parish office, open on election day</li>
